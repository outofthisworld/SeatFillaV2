...
module.exports = {
  ...
  createApiRequest: function (obj) {
    return new Promise(function (resolve, reject) {
         this.locateApiUser({token:this.findApiTokenFromRequest(obj)}).then(function (apiUser) {
          ApiRequest.create({
            ...
            if (err){
              return reject(err)
               ...
               ApiUsers.publishAdd(result.id,'apiRequests',result);
               ApiRequest.publishCreate(result);
