...
$(document).ready(function () {
  (function initMap (options) {
    ...
    window.seatfilla.globals.geolocation.queryAirports([sf_map.location.address.region, sf_map.location.address.city],
      handle.bind({element: $('#airports_selections'),options: {addMarkers: false}}))
    ...
    $('#Search').click(function () {
      ...
      window.seatfilla.globals.geolocation.queryAirports([query], handle.bind({element: $('#destination_airports'),options: {addMarkers: true}}))
    })
