    ...
    module.exports = {
        tokenRequiresVerification(requestPermissions) {
            ...
            for (var key in Object.keys(requestPermissions)) {
                if (key in apiPermissions) {
                    requiredVerification = requiresVerification || apiPermissions[key];
                }
            }
        ...
        createApiUser: function(user, apiToken, permissions) {
            ...
            return new Promise(function(resolve, reject) {
                ApiUsers.create({
                    apiToken: apiToken,
                    isVerified: !this.tokenRequiresVerification(permissions),
                    isBlocked: false,
                    user: user.id,
