    ...
    (function($) {
        ...
        $.views.helpers({
            range: function(from, to) {
                return Array.apply(null, Array(to - from < 0 ? 0 : to - from)).map(function(_, i) {
                    return i + from;
                })
            },
            floor: function(num) {
            ...
            minimum: function(arr, attrMapping) {
                return Math.min.apply(null, !attrMapping ? arr : arr.map(function(item) {
                    return item[attrMapping]
                }))
            },
            maximum: function(arr, attrMapping) {
                return Math.max.apply(null, !attrMapping ? arr : arr.map(function(item) {
                    return item[attrMapping]
                }))
            },
