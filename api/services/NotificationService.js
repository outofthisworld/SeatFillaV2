...
module.exports = {
  ...
  sendDedicatedNotificationAsync: function (req, done) {
    ...
    return function (message) {
      ...
      function cb (func, args) { if (func && typeof func === 'function') func.apply(null, args)}
    ...
    return new Promise(function (resolve, reject) {
      async.auto({
        ...
        createSystemNotification: ['createNotification', function (callback) {
          SystemNotifications.create(Object.assign({link: '/',title: 'System Notification'}, message)).exec(function (err, message) {
            if (err) {
              return callback(err, null)
            } else {
