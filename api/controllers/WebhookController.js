    ...
    */
    create(req,res){
        return new Promise(function(resolve,reject){
            ...
            message, 
            algorithm, 
            apiUser, {webHookTypes:Object.keys(req.allParams())}).then(function(webhook){
    ...
    sendWebhookVerification(req,res){
        ...
        .then(function(result){
            return res.ok(result,{view:'webhook/sendWebhookVerificationSuccess'})
        }).catch(function(err){
            return res.badRequest({error:err},{view:'webhook/sendWebhookVerificationFailiure'})
        })
    },
    verifyWebhook(req,res){
        ...
        token:req.param('verificationToken')
            ...
            if(result && result.isVerified){
                return res.ok(result,{view:'webhook/verificationSuccess'})
            }else{
