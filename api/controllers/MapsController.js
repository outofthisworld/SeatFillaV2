module.exports = {
    ...
    retrieveFlightInfo(req, res) {
        async.auto({
            ...
            createSessionObject: ['getUserCurrencyCodePreference', function(callback, result) {
                ...
                obj.country = (req.body.userLocation && req.body.userLocation && req.body.userLocation.address.countryCode) || (req.body.origin && req.body.origin.airportCountryId) || (req.user && req.user.address.country) || 'US';
    ...
    pollSkyScannerFlightLivePricingApi(req, res) {
        ...
        GettyImagesService.searchAndRetrieveUrls({
            ...
            pageSize: gettyImagesPageSize || 10
        }).then(function(data) {
